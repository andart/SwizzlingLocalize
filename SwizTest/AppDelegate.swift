...
//        swizzleMethod(UIButton.self, originalSelector: #selector(UIButton.setTitle(_:for:)), swizzledSelector: #selector(UIButton.swizzledSetTitle(_:for:)))
//        swizzleMethod(UIButton.self, originalSelector: #selector(UILabel.awakeFromNib), swizzledSelector: #selector(UILabel.swizzledAwakeFromNib))
